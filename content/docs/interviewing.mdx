---
title: Interviewing
description: "How I got offers from OpenAI, Cursor, ElevenLabs, Vercel, etc."
centered: true
published: true
tags: ["Writing"]
...
This is the playbook I and many friends have followed to land jobs at OpenAI, Cursor, and similar companies, without impressive backgrounds. The interviews aren't much harder than at other startups. If you're willing to put in a few months of focused effort, it's achievable. It won't be pleasant, but it's very likely to increase your salary by 3-10x.
...
- **Warm intros:** Don't underestimate weak ties. People you've only talked to once or twice can often lead to the best opportunities. I got an intro to ElevenLabs through someone I'd talked to once six months earlier.
- **Going viral:** The biggest unlock was having a [tweet](https://x.com/fredrikalindh/status/1986473781825605891) go viral. It got me messages from Cursor, OpenAI, Cognition, and Vercel. You don't need a big audience. I had around 500 followers. Post before 10 AM PST, record a short demo (I used [Screen Studio](https://screen.studio/)), and ask a few friends to like/retweet/reply early. If a tweet gets a few thousand impressions with good engagement, it will usually take off.
