...
import { EXAMPLE_DIFF, SIMPLE_DIFF, DISSIMILAR_DIFF } from '@/registry/blocks/diff-viewer/data';
...
<DiffViewer patch={DISSIMILAR_DIFF} options={{ similarityThreshold: 0 }} />
...
<Tabs defaultValue="GitHub">
  ...
  <TabsContent value="Similar">
    <DiffViewer patch={EXAMPLE_DIFF} options={{ mergeModifiedLines: false,  maxDiffDistance: 10 }} />
  </TabsContent>
</Tabs>
